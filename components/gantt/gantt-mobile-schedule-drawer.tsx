                ...
                {metricIds.map((id) => {
                  ...
                  return (
                    <div
                      key={id}
                      className={cn(
                        "flex items-center justify-center border-b border-blue-100/90 px-0.5 text-center text-[9px] tabular-nums text-gray-700 last:border-b-0 dark:border-blue-900/45 dark:text-gray-200",
